...
<img src="picture/状态栏及其适配/应用截图.png" alt="应用截图" style="zoom: 25%;" />
...
<img src="picture/状态栏及其适配/DecorView流程.png" alt="DecorView流程" style="zoom:50%;" />
...
<img src="picture/状态栏及其适配/透明效果4.4.png" alt="透明效果4.4"  />

5.0透明效果

<img src="picture/状态栏及其适配/透明效果5.0.png" alt="透明效果5.0"  />
...
<img src="/Users/lm99/Documents/状态栏及其适配/状态栏例子4.4.png" alt="透明状态栏例子" style="zoom:33%;" />
...
```java
getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS); getWindow().clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS); getWindow().setStatusBarColor(ContextCompat.getColor(this,android.R.color.colorPrimaryDark));

```

​	效果图：

<img src="/Users/lm99/Documents/状态栏及其适配/状态栏例子5.0.png" alt="状态栏例子5.0" style="zoom:33%;" />
